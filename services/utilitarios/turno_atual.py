...
from services.utilitarios import fim_de_jogo, impressoes
from models import enums_utilitarios
import copy

jogadores = enums_utilitarios.Jogador

def turnoAtual():
    if settings.jogador_atual == jogadores.JOGADOR_DE_BRANCAS.value:
        impressoes.imprimirTituloIsolado("- VEZ DAS BRANCAS ♚")
    elif settings.jogador_atual == jogadores.JOGADOR_DE_PRETAS.value:
        impressoes.imprimirTituloIsolado("- VEZ DAS PRETAS ♔")
    ...
    peca_escolhida = "entrada invalida"
    nova_posicao = "entrada invalida"
    peca_esta_selecionada = False
    posicao1 = 0
    posicao2 = 0
    peca = None
    jogada_precisa_ser_escolhida = True

#         while jogada_precisa_ser_escolhida == True:
#             jogada_precisa_ser_escolhida = False
#             while peca_esta_selecionada == False:
#                 tabuleiros.imprimirTabuleiro(jogador)
...
#                 while posicoes.testarValidezCoordenada(nova_posicao, True, tabuleiro_movimentos) != 0 and peca_esta_selecionada == True:
#                     print("==========================================================================================================") 
